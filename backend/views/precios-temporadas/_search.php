...
/* @var $model common\models\PrecioTemporadaSearch */
...
<div class="paradas-search">
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-xs-12" style="margin-top: 15px">
            <label>Precio</label>
        ...
        <div align="right" class="col-lg-2 col-md-2 col-xs-12" style="margin-top: 30px">
            <?= Html::submitButton('BUSCAR PRECIO TEMPORADA', ['class' => 'btn btn-success']) ?>
        </div> 
