  ...
  if ($model->factura === 0) {
    ...
    if ($factura_reserva == NULL) {
      ...
      $nota = 'LA RESERVA TIENE UNA FACTURA ASOCIADA'.Html::a(
        'Ver Factura', 
        [
          'facturas/view', 'id' => $factura_reserva->id_factura
        ], 
        [
          'class' => 'btn btn-success btn-xs btn-factura'
        ]
  ...
  <div class="title-margin-new">
    ...
    <div class="row">
      ...
      foreach ($ser as $s): $datos = Servicios::find()->where(['id'=> $s->id_servicio])->one(); 
        ...
        <div class="col-lg-12"><hr style="margin-top: 10px"></div>
            ...
            <div class="col-lg-6">
              ...
              <div class="nota-descripcion"><li><?= $nota; ?></li></div>
            </div>            

            <div align="right" class="col-lg-6" style="margin-top: 25px">
