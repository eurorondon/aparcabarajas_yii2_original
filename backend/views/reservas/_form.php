                ...
                <div class="col-lg-12 pad-0" style="padding-left: 0px">
                    <div class="panel panel-default panel-d">
                        <div class="panel-body panel-dates">
                            ...
                            <input type="hidden" name="servicio_noc_id"
                                value="<?= substr($nocturno[0]['id'], 0, -2) ?>">
                            <input type="hidden" id="servicio_noc" name="servicio_noc_costo"
                                value="<?= $nocturno[0]['costo'] ?>">

                            <?php if ($nocturno[0]['id'] === '11-1') { ?>
                        ...
                        <div class="panel panel-default panel-d d2" style="margin-bottom: 0px">
                            <div class="panel-body panel-dates otherp">
                                    ...
                                    <div style="padding-top: 10px;">
                                        <div class="col-lg-12 pad-0" style="padding: 0px">
                                            ...
                                            <?= $form->field($model, 'descuento')->widget(Select2::classname(), [
                                                'data' => ['SI' => 'SI', 'NO' => 'NO'],
                                                'options' => ['placeholder' => 'Selecccione', 'value' => 'NO'],
                                                'pluginOptions' => [
                                                    'allowClear' => true
                                                ],
                                            ])->label(false); ?>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div style="padding-top: 10px;">
                                        <div class="col-lg-12 pad-0" style="padding: 0px; display:none" id="monto_des">
                                            <label>MONTO DESCUENTO</label>
                                            <?= $form->field($model, 'monto_des')->textInput(['value' => 0, 'type' => 'number', 'min' => 0, 'max' => 100])->label(false) ?>
                                        </div>
                                    </div>
                                </div>
  ...
  function selectCarro(marca, matricula){
    ...
    $('#reservas-descuento').on('change', function(){
        if($(this).val() === 'SI'){
            ...
            var monto_total = parseFloat($('#reservas-costo_servicios').val()) + parseFloat($('#total_seguro').val());
                  ...
                  $('.servicios:checkbox:not(:checked)').each(function() {
                    ...
                    $('#subtotal-factura').click(function() {
                      ...
                      $('#reservas-techado:checked').each(function() {
                        precio_techado = $('#total_techado').val();
                        console.log(precio_techado);
...
<script>
    ...
    setTimeout(() => {
        /*var isNoc = $('#is_noc').val();
        var extraNocturno = $('#servicio_noc').val();
        if(isNoc === '11-1'  && extraNocturno !== 0){
