            ...
            <div class="panel-body body-busqueda b2">
              ...
              <div class="row">
                ...
                <div align="right" class="col-lg-4">
                  ...
                  <?= count($reservas_entrada_1) > 0 ? Html::button('Imprimir Tickets & Sobres - Reservas Entrantes', [
              ...
              <div class="row">
                ...
                <div align="right" class="col-lg-4">
                  ...
                  if (count($reservas_salida_1) > 0) {
                    ...
                    $ids_salida_imprime= json_encode([]);
                    $ids_salida_imprime = json_encode([]);
                  }
                  
                  ?>

                  <?= count($reservas_salida_1) > 0 ? Html::button('Imprimir Tickets & Sobres - Reservas Salientes', [
