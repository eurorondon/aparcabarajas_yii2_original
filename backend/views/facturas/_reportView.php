...
<table>
	<tr>
		...
		<td class="title-table" align="center" width="12cm"><div class="texto">Descripción</div></td>
		<td class="title-table" align="center" width="1.5cm"><div class="texto">Cant</div></td>
		<td class="title-table" align="center" width="2.5cm"><div class="texto">P. Unit</div></td>
	...
	<tr>
		...
		<td class="title-section-t" align="left" width="12cm">
		...
		<td class="title-section-t" align="center" width="1.5cm">
			<div class="texto"><?= $s->cantidad ?></div>
		</td>		
		<td class="title-section-t" align="right" width="2.5cm">
			<div class="texto"><?= round($punitario,2) ?> €</div>
		</td>
		<td class="title-section-t" align="right" width="2.5cm">
...
if (count($service) === 0) { ?>
	...
	<tr>
		...
		<td class="title-section-t" align="center" width="1.5cm">
			<div class="texto"><?= round($other_service->cantidad) ?></div>
		</td>		
		<td class="title-section-t" align="right" width="2.5cm">
			<div class="texto"><?= round($other_service->punitario,3) ?> €</div>
		</td>
		<td class="title-section-t" align="right" width="2.5cm">
			<div class="texto"><?= round($other_service->ptotal,3) ?> €</div>
		</td>
	</tr>
<?php } ?>
...
<table>
	...
	<tr>
		...
		<td align="right" class="title-section-t" width="3cm" style="border-top: 2px solid">
			<div class="texto-total" style="font-weight: bold;"><?= round($model->monto_total,2) ?> €</div>
		</td>
	</tr>		
</table>
...
<table class="otros">
	...
	<tr>
		<td class="title-section-t" align="center" width="19cm">
			<div class="texto-min2">ES22 0182 2082 1002 0167 8477</div>
		</td>	
	</tr>
</table>
...
<div class="direccionf">APARCAMIENTOS BLACK SL,<br>Calle Playa de riazor 14, CP 28042 / NIF B56956725</div>
