...
<div class="facturas-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 subtitulo-reserva" style="margin-top: 0px; margin-bottom: 20px ">Datos del Cliente</div>
        <br>
        ...
        $num = 1;
        for ($i = 0; $i < $cant; $i++) {
            // $price = $precio_diario[$i]['precio'] / ($iva);
            // $precio[$i] = round($price, 3);
            ?>
            <div class="hide col-lg-2">
                <input class="form-control" style="margin-bottom: 20px" type="text" id="precio-diario<?= $num ?>"
                    value="<?= $precio[$i] ?>">
            </div>
            <?php $num++;
        } ?>
        ...
        $('.servicios').change(function() {
            ...
            $('#cantidad'+ id).change(function() {
                ...
                if (tipo_servicio == 0) {
                    ...
                    $('#precio_total'+ id).val(total.toFixed(3));
                    $('.totales-facturas').click(); 
