...
<head>
	...
	<style type="text/css">
		...
		.inf-footer {
			background-image: url("https://aparcabarajas.es/aparcamiento/backend/web/images/footer.png");
			padding: 20px 20px;
		}
...
<body>
	...
	<table style="width:570px;height:auto;background:#fff;margin:0 auto">
		<tbody>
			<tr>
				<td>
					<table style="border:1px solid #B0CB21;box-sizing:border-box;margin:0 auto;width:100%" border="0"
						cellspacing="0" cellpadding="0">
						<tbody>
							<tr>
								<td colspan="3" align="center">
									<div
										style="width:100%;height:100px;background:url(https://aparcabarajas.es/aparcamiento/backend/web/images/headerplus.png) no-repeat 40%">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td width="50%" colspan="3">
									<div
										...
										N° de Reserva:
										<div style="color:#B0CB21;padding-left:1px;display:inline;font-weight:700">
							...
							<tr>
								<td colspan="3"
									style="width:99%;height:60px;margin:0 auto;font-style:normal;font-weight:600;font-size:20px;line-height:20px;text-align:center;letter-spacing:-.03em!important;color:#fff;padding:0 20px;background:#B0CB21">
									<div style="padding-top:5px; padding-bottom: 5px">
										Aparcabarajas - Valet - Aeropuerto de Madrid Barajas
									</div>
							...
							<tr>
								<td colspan="3" height="10px" style="border-bottom:1px solid #B0CB21"></td>
							</tr>
							<tr>
								<td colspan="3"
									style="vertical-align:bottom!important;height:200px!important;border-bottom:1px solid #B0CB21;background-image:url('https://ci4.googleusercontent.com/proxy/0hRLZaFdjmPxUf0ScSWpKpDzk8BjU9NTSAR5PSoeWKCLuRkhL-oORxnjpjjbHXY-E9h6krWZE3ediMNWlbnmUw2MWp6PlrnioBy4tUthpXP1F3eMlhLSKdJzIp9e4S_edCWOjjn61ZoALofk7coF_oyFfj2PkuUjwyTcc_Fj4nI2XHkhEP_c2Pb8HJT2Bom93BZIIapdy0TSv2y1-sDzjoWiyAKux-H9tH1IbRS0jMymejU8F2aBGLY9OvYKPcT20K2y5Iwu9mjg3-2_ZUPw2gREbT7U5TZd2__p2sceV7wC7yYhcSpPmNlr3utGKqtenRiDLQ74WbiCEJJYT4rrfKNjqkkPPesS1OV9xJkay-T2wuuvGgko8s9Rlw=s0-d-e1-ft#https://maps.googleapis.com/maps/api/staticmap?zoom=18\000026scale=false\000026size=588x200\000026maptype=roadmap\000026sensor=false\000026format=png\000026visual_refresh=true-Ws\000026key=AIzaSyDVp3PJw4jyDYFPEcjfU16JN5XmZB95-Ws\000026center=40.49322933989,-3.593633415943\000026markers=40.49322933989,-3.593633415943')">
								</td>
							</tr>
							<tr>
								<td colspan="3" style="border-bottom:1px solid #B0CB21;padding-top:10px!important">
									<table width="97%" border="0" align="center">
										<tbody>
														...
														<tbody>
															<tr>
																<td width="10px" valign="top">
																	<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/ir.png"
															...
															<tr>
																<td colspan="2" width="100%" valign="middle">
																	<div
																		...
																		que debes llamar es el +34 604194861. Durante la
															...
															<tr>
																<td colspan="2" width="100%" valign="middle">
																	<div
																		...
																		+34 604194861. Durante la llamada, una persona
											...
											<tr>
												<td colspan="2" style="border-top:1px solid #B0CB21;padding:20px 0px">
			...
			<tr>
				<td align="center" colspan="3">
					<div
						style="padding: 0px;width:100%;height:80px;background:url(https://aparcabarajas.es/aparcamiento/backend/web/images/footer.png) no-repeat 100%">
						<ul class="ul">
							<a href="mailto:contacto@aparcabarajas.es" class="vinculo" rel="noreferrer noreferrer"
								target="_blank">
								<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/correo.png"
									alt="Contacto Aparcabarajas" style="padding: 0;	max-width: 120%;border: none;">
							</a>
							</li>
							<li class="li">
								<a href="https://www.facebook.com/aparcabarajas/" class="vinculo"
									rel="noreferrer noreferrer" target="_blank">
									<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/face.png"
										alt="Facebook Aparcabarajas" class="icon-enlace">
								</a>
							</li>
							<li class="li">
								<a href="https://www.instagram.com/aparcabarajas/" class="vinculo"
									rel="noreferrer noreferrer" target="_blank">
									<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/insta.png"
										alt="Instagram Aparcabarajas" style="padding: 0;	max-width: 120%;border: none;">
								</a>
							</li>
							<li class="li">
								<a href="https://twitter.com/aparcabarajas" class="vinculo" rel="noreferrer noreferrer"
									target="_blank">
									<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/twitter.png"
										alt="Twitter Aparcabarajas" style="padding: 0;	max-width: 120%;border: none;">
								</a>
							</li>
							<li class="li">
								<a href="tel:+34613910571" class="vinculo" rel="noreferrer noreferrer" target="_blank">
									<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/telefono.png"
										alt="Teléfono Aparcabarajas" style="padding: 0; max-width: 120%;border: none;">
								</a>
							</li>
							<li class="li">
								<a href="https://api.whatsapp.com/send?phone=+34613910571&text=Estoy Interesado en los Servicios que Ofrecen !"
									class="vinculo" rel="noreferrer noreferrer" target="_blank">
									<img src="https://aparcabarajas.es/aparcamiento/backend/web/images/ws.png"
										alt="Whatsapp Parking Plus" style="padding: 0;	max-width: 120%;border: none;">
								</a>
							</li>
						</ul>
					</div>
