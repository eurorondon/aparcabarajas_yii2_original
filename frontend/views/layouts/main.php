...
<head>
    <link rel="shortcut icon" href="<?php echo Yii::$app->request->baseUrl; ?>/frontend/web/images/favicon1.ico"
        type="image/x-icon" />
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-QLXKLSCF78">
    </script>
    <script>
    ...
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-NCVDNNCN');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NCVDNNCN" height="0" width="0"
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <span class="logo me-auto"><a href=""
                    style="    position: absolute;padding-top: 2%;"><?= Html::img('@web/images/logo_apv.png') ?></a>
            </span>
                ...
                <ul>
                    ...
                    if (Yii::$app->user->isGuest) {
                        ...
                        <li><a class="nav-link scrollto active"
                                href="https://www.aparcabarajas.es/aparcamiento/site/index#skills">COMO FUNCIONA</a></li>
                        <li><a class="nav-link scrollto"
                                href="https://www.aparcabarajas.es/aparcamiento/site/index#services_ex">SERVICIOS</a></li>
                        <li><a class="nav-link scrollto"
                                href="https://www.aparcabarajas.es/aparcamiento/site/index#atencion_cliente">ATENCION AL
                                CLIENTE</a></li>
                        <li><a class="nav-link   scrollto"
                                href="https://www.aparcabarajas.es/aparcamiento/site/index#contact">CONTACTO</a></li>
    ...
    <footer id="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 footer-contact">
                        <div class="con"
                            ...
                            <div>
                                <a href=""><?= Html::img('@web/images/logo_apv_2.png'); ?></a>
                            </div>
                        ...
                        <div class="footer__social">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/aparcabarajas" target="_blank">FaceBook</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://www.instagram.com/aparcabarajas" target="_blank">Instagram</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <h5 class="h5">+34 613 91 05 71 / +34 604 19 48 61</h5>
                        <h4><strong>Correo</strong></h4>
                        <h5 class="h5">contacto@aparcabarajas.es</h5>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <div class="con">
                            ...
                            <div style="margin-bottom: 5%; text-align: center;">
                                <?= Html::img('@web/images/gplay.png'); ?>
                            </div>
                            <div style="margin-bottom: 5%; text-align: center;">
                                <?= Html::img('@web/images/appstore.png'); ?>
                            </div>
                        </div>
                    </div>
        ...
        <a href="https://wa.me/+34613910571?text=Requiero informacón del servicio" class="btn-wsp btn-floating" target="_blank">
			<i class="fa-brands fa-whatsapp"></i>
		</a>

		<!-- <a href="tel:+34613910571" class="btn-phone btn-floating">
