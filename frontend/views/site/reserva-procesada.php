            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-xs-12">      
                        ...
                        <p align="right" style="margin-top: -35px; margin-right: 120px;"><a class="reborde phone-min" style="font-size: 0.9em;" href="tel:+34912147984"> +34 604 19 48 61</a></p>
                    </div>
                </div>
        ...
        <div class="row" style="margin-top: 0px">
            <div class="col-lg-12">
                <div class="title-m" align="center" style="margin-bottom: 15px">
                    <h3>Resumen de Reserva - Aparcabarajas</h3>
                </div>
