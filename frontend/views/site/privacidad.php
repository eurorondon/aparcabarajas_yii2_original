...
$this->title = Yii::$app->name.' | Política de Privacidad';
$this->params['breadcrumbs'][] = 'Política de Privacidad';

?>

<div class="panel panel-default" style="margin: 0px 10px; padding: 5px">
	<div class="panel-heading title-promo" style="font-size: 1em; text-transform: uppercase;">Política de Privacidad "Sus Datos Seguros"</div>
	<div class="panel-body" style="padding: 10px 30px 20px 30px">
		<div class="row">
			<div class="col-lg-12">
				...
				<p align="justify"><b>Muchas gracias por su colaboración.</b></p>


				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿QUIÉNES SÓMOS?</p>

				<ul>
					<li>Nuestra denominación: Aparcamientos Black S.L</li>
					<li>Nuestro CIF / NIF: B56956725</li>
					<li>Nuestra actividad principal: Empresa de alojamiento de vehículos (Parking)</li>
					<li>Nuestra dirección: C/ playa de riazor 14, CP 28042</li>
					<li>Nuestro teléfono de contacto: 613970571</li>
					<li>Nuestra dirección de correo electrónico de contacto: contacto@aparcabarajas.es</li>
					<li>Nuestra página web: www.aparcabarajas.es</li>
				</ul>

				<br>
				<p><b>Estamos a su disposición, no dude en contactar con nosotros.</b></p>

				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿PARA QUÉ VAMOS A USAR SUS DATOS?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿POR QUÉ NECESITAMOS USAR SUS DATOS?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿QUIÉN VA A CONOCER LA INFORMACIÓN QUE LE PEDIMOS?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿CÓMO VAMOS A PROTEGER SUS DATOS?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿ENVIAREMOS SUS DATOS A OTROS PAÍSES?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿DURANTE CUÁNTO TIEMPO VAMOS A CONSERVAR SUS DATOS?</p>				
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿CUÁLES SON SUS DERECHOS DE PROTECCIÓN DE DATOS?</p>
				...
				<p align="justify">Para saber más sobre sus derechos de protección de datos, puede consultar la  página web de la Agencia Española de Protección de Datos (www.agpd.es).</p>


				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿PUEDE RETIRAR SU CONSENTIMIENTO SI CAMBIA DE OPINIÓN EN UN MOMENTO POSTERIOR?</p>				
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">EN CASO DE QUE ENTIENDA QUE SUS DERECHOS HAN SIDO DESATENDIDOS, ¿DÓNDE PUEDE FORMULAR UNA RECLAMACIÓN?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿ELABORAREMOS PERFILES SOBRE USTED?</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 40px; color: #921007">¿USAREMOS SUS DATOS PARA OTROS FINES?</p>
