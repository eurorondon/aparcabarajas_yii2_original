...
Modal::begin([
	'header' => '<h3 class="modal-title">COSTO DEL SERVICIO</h3>',
	'id' => 'fecha_reserva',
	'size' => 'modal-xl',
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
					...
					<h1 
  class="h2generada d-inline bg-primary text-white px-4 py-2 rounded text-center fs-3 fs-lg-2" 
  style="background-color: #B0CB21; line-height: 1.2;">
  APARCAMIENTO AEROPUERTO MADRID<br>
  <span class="fs-6">Parking Aeropuerto Madrid</span>
</h1>
...
<br />
					<!--<h2 class="h2generada fs-2 fs-md-3 fs-lg-1"> OFERTA EXCLUSIVA
    
</h2>-->
					
					<h2 class="h2generada fs-2 fs-md-3 fs-lg-1 mt-3"> 
     Parking Aeropuerto Madrid, Barajas
</h2>
						...
						<!-- <h2>Reserva tu Plaza con Aparcamiento Seguro</h2> -->
						<!-- <h3>Parking Larga Estancia T4</h3>
					<h3>Parking Cubierto Aeropuerto Madrid</h3>
					<h3>Parking Barajas T1</h3>
					<p>Aparcar en Madrid aeropuerto</p>
					<p>Parking barato Barajas</p>
					<p>Aparcar en Madrid aeropuerto T4</p>
					<p>Aparcar en el aeropuerto Madrid Barajas</p> -->
						<p class="mt-5" style="color: #FFF; font-weight: bold;">
							Servicios de Aparcamiento T1 , Aparcamiento T2 o Aparcamiento T4. A tu vuelta, te
							estaremos esperando en la puerta de la terminal.</p>
				</div>
				<div class="col-lg-6 order-1 order-lg-2 hero-img" style="color: white;" data-aos="zoom-in"
					data-aos-delay="200">
<!--
					<svg class="time_reserva" width="118px" height="118px" viewBox="0 0 158 158" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fragment="12340db49ac" class="z-0 md:hidden font-sans absolute md:-top-48 sm:-top-26 md:-right-8 lg:-right-16 h-32 xxxs:h-auto -top-18 xxxs:-right-5 -right-5 xxxs:-top-18">
						<title>Group 3</title>
						<defs>
							<rect id="path-1" x="0" y="0" width="158" height="158" rx="79"></rect>
						...
						<g id="Final" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<g id="Landingpage_final_desktop_IT" transform="translate(-860.000000, -82.000000)">
								<g id="Group-13" transform="translate(822.000000, 82.000000)">
									<g id="Group-3" transform="translate(38.000000, 0.000000)">
										<rect id="Rectangle" fill="#B0CB21" x="10.8965517" y="10.8965517" width="136.206897" height="136.206897" rx="68"></rect>
										<use id="Rectangle" stroke="#B0CB21" mask="url(#mask-2)" stroke-width="8" stroke-dasharray="2" xlink:href="#path-1"></use> <text id="per-prenotare" transform="translate(86.618749, 96.891934) rotate(-20.000000) translate(-86.618749, -96.891934)" font-family="Open Sans, sans-serif" font-size="15" font-weight="800" fill="#FFFFFF">
											<tspan x="57.6187491" y="103.391934">
												por dia
											</tspan>
										</text> <text id="3-MIN" transform="translate(76.579658, 71.109202) rotate(-20.2) translate(-76.579658, -71.109202)" font-family="Open Sans, sans-serif" font-size="50" font-weight="800" fill="#FFFFFF">
											<tspan x="50.0796584" y="85.1092018">6€ </tspan>
										</text>
									</g>
								</g>
							</g>
 ...
 -->
					...
					<div class="row" id="calc_reserva"
						style="display: flex; flex-direction: column; width: 100%; justify-content: center;align-items: center;	gap: 35px;">
													...
													<div class="input-group-prepend" id="rec">
														<span class="input-group-text1" id="basic-addon1">
															<?= $form->field($model, 'fechae')->widget(DatePicker::classname(), [
																'options' => ['value' => date('d-m-Y'), 'autocomplete' => 'off', 'onfocus' => 'blur()', 'style' => 'width: 100%;'],
																'language' => 'es',
																'removeButton' => false,
																'pluginOptions' => [
						...
						<div class="col-sm-12 col-lg-12 separa">
							<div class="card">
								<div class="card-body1">
									<div class="row">
										<div class="col-sm-12">
						...
						<div class="col-sm-12 col-lg-12 msg-fechas" style="display:none">
							<div class="card">
								<div class="card-body1">
									<div class="row">
										<div class="col-sm-12 py-2 px-4" style="color: red">
						...
						<div id="" class="col-sm-12 col-lg-12 msg-fecha-parada" style="display:none">
							<div class="card">
								<div class="card-body1">
									<div class="row">
										<div class="col-sm-12 py-2 px-4" style="color: red">
											* Para la fecha de entrada o salia no tenemos plazas disponible
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12 col-lg-10 separa d-flex" id="button-hero">

							<?= Html::button('CALCULAR TARIFA', [
								'class' => 'btn btn-lg text-white calcular',
								'style' => 'background-color: #B0CB21;font-weight: 600;'
							]) ?>

							<?= Html::button('RESERVA AHORA MISMO', [
								'class' => 'btn btn-lg text-white calcular',
								'style' => 'background-color: #B0CB21;font-weight: 600;'
							]) ?>
							<?php /* Html::button('CALCULAR TARIFA', [
															'value' => Yii::$app->urlManager->createUrl('/site/fechas'),
															'class' => 'calcular',
															'id' => 'BtnModalId',
															'data-toggle' => 'modal',
															'data-target' => '#fecha_reserva',
															'style' => 'background-color: #B0CB21;border: none;'
														]) */ ?>
							<!--<a href="" class="calcular" data-bs-toggle="modal" data-bs-target="#exampleModal">
					CALCULAR TARIFA
				</a>-->
						</div>
					</div>
	...
	<main id="main">
		...
		<section id="skills" class="price container">
			<h2 class="subtitle" data-aos="fade-up">Reserva fácil en 3 pasos</h2>

			<div class="price__table">
				<div class="price__element" data-aos="fade-left">
					<h2 class="price__name">Paso 1</h2>
					<h3 class="price__price">Reserva</h3>

					<div class="price__items">
						<p class="price__features">
							Selecciona las fechas e ingresa tus datos, te enviaremos la confirmación del servicio de Aparcamiento de
							manera automatica.
						</p>
					</div>
				...
				<div class="price__element price__element--best" data-aos="fade-down">
					<h2 class="price__name">Paso 2</h2>
					<h3 class="price__price">Recogida</h3>

					<div class="price__items">
						<p class="price__features">Nuestro Personal recogerá su vehículo en la puerta de la Terminal indicada en el Aeropuerto de Madrid. Con
				...
				<div class="price__element" data-aos="fade-right">
					<h2 class="price__name">Paso 3</h2>
					<h3 class="price__price">Entrega</h3>

					<div class="price__items">
						<p class="price__features">Nuestro personal entregará el vehículo en la puerta de la Terminal a su
							previa confirmación de llegada al Aeropuerto de Madrid.<br><br></p>
					</div>
		...
		<section class="beneficios magicpattern">
			<h2 class="beneficios__title" data-aos="flip-down">Servicio Premium</h2>
				...
				<div class="beneficio__content">
					<div class="beneficio" data-aos="slide-left">
						...
						<p class="beneficio__paragraph">
							...
							Cliente, tanto telefónico como vía e-mail para su Aparcamiento de Madrid Barajas.
						</p>
					</div>
					<div class="beneficio" data-aos="slide-left">
						...
						<p class="beneficio__paragraph">
							...
							propio Aeropuerto de Madrid Barajas.
						</p>
					</div>
					<div class="beneficio" data-aos="slide-left">
						...
						<p class="beneficio__paragraph">
							...
							los 365 días del año en los servicios de Parking en Aparcabarajas.
						</p>
					</div>
					<div class="beneficio" data-aos="slide-left">
						<h3 class="subtitle__one">24 Horas</h3>
						<p class="beneficio__paragraph">
							Nuestro servicio de Parking Aparcabarajas funciona las 24 horas continuamente, sea cual sea el horario de su vuelo
							tanto en la ida como a su regreso con Aparcabarajas nunca tendrá problemas de esperas en el Aeropuerto de Madrid.
						</p>
					</div>
				</div>
			</div>
		...
		<section class="counter">
			<div class="container counter__grid">
				<div class="counter_container" data-aos="zoom-in">
					...
					<div class="counter__description">Desde la pag <br />www.aparcabarajas.es</div>
				</div>
		...
		<section class="promo container">
			<h3 class="subtitle" data-aos="zoom-in">Servicios de Parking Garantizados</h3>
			...
			<div class="container" data-aos="fade-up">
				<div class="row">
					<div class="col-sm-6">
						...
						<h3>Nuestro Parking situado junto al Aeropuerto de Madrid Barajas, cuenta con todo lo
							necesario para que viaje tranquilo y su vehículo esté siempre seguro.A precios tan económicos y de calidad.
							¿Por qué pagar más?</h3>
					</div>
				</div>
			</div>
			<div id="container-main">
						...
						<div class="row">
							<div class="col-md-12">
								<p class="content_atencion">Contamos con varios medios para reservar, a través de
									nuestra página web <b>aparcabarajas.es</b> o a través de nuestro número de contacto
									<a href="tel:+34613910571">613910571</a> ò <a href="tel:+34604194861">604194861</a>.
									<br />
									...
									en el caso de no recibir este mail podéis llamar al número de reservas <a
										href="tel:+34613910571">613910571</a>,
									...
									contactar al <a href="tel:+34604194861">604194861</a> para que el personal de
									asistencia
						...
						<div class="row">
							<div class="col-md-12">
								<p class="content_atencion">Una vez efectuada la reserva, debes llamar 20 min antes de
									...
									número <a href="tel:+34613910571">613910571</a> indicando su matrícula, el conductor
				...
				<div class="accordion-container" data-aos="slide-right">
					...
					<div class="accordion-content">
						<div class="row">
							<div class="col-md-12">
								<p class="content_atencion">En aparcabarajas cuidamos tu coche por lo que al momento de
		...
		<section id="services_ex" class="testimonials">
			...
			<div class="container" data-aos="fade-up">
				<div class="row">
					<div class="col-md-12">
						<h2 class="subtitle">
							Servicios Extras en Aparcabarajas
						</h2>
						<h4 class="extra__subtitle">Contamos con servicios adicionales en el parking de los que podrá beneficiarse
							a precios magníficos. Así mientras Ud está de viaje su vehículo estará reluciente a su regreso.</h4>
					</div>
				</div>
				<div class="row">
					<!-- Swiper -->
									...
									<div class="col-md-4" data-aos="slide-left">
										<div class="card">
											...
											<div class="card-body" style="height: 350px;">
												...
												<div>
													<a href="#fechas-form" class="btn btn-parking2  btn-lg service_card"
														style="width: 90%;">
														SOLICITAR
													</a>
												</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-lg-4 d-flex flex-column justify-content-center align-items-stretch"
						...
						<?= Html::img('@web/images/atencion_cliente.webp', ['class' => 'cliente__img']) ?>
					</div>

					<div class="col-sm-8 col-lg-8 align-items-stretch order-1 order-lg-2" style="text-align: center;">
						<div class="row" style="margin-bottom: 5%;">
							<h2 class="subtitle" data-aos="flip-up" data-aos-offset="200">
								Atención al Cliente
							</h2>
							<h3 class="" data-aos="slide-up" data-aos-offset="200">Contando siempre con la ayuda de un
							...
							<div class="col-md-6" data-aos="zoom-in" data-aos-offset="100">
								...
								<button class="btn btn-parking2 btn-lg" style="width: 100%;">
									<a class="reborlink" href="tel:+34613910571">
										<p class="atencion" style="margin: 0px; color:#000; font-weight: 500;">+34 613
											91 05 71</p>
									</a>
								</button>
							</div>
						...
						<div class="row" style="margin-bottom: 5%;">
							<div class="col-md-6" data-aos="zoom-in" data-aos-offset="100">
								<h6 class="reserva">Asistencia en Aeropuerto Madrid</h6>
								<button class="btn btn-parkin btn-lg" style="background: #000;">
									<a class="reborlink" href="tel:+34604194861">
										<p class="atencion" style="margin: 0px; color:#FFF; font-weight: 500;">+34 604
											19 48 61</p>
									</a>
								</button>
							</div>
							<div class="col-md-6" data-aos="zoom-in" data-aos-offset="100">
								<h6 class="reserva">contacto@aparcabarajas.es</h6>
								<button class="btn btn-parking2 btn-lg" style="width: 100%;">
									<a class="reborlink" href="mailto:contacto@aparcabarajas.es">
										<p class="atencion" style="margin: 0px; color:#000; font-weight: 500;">
											ESCRIBENOS</p>
									</a>
								</button>
							</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12" data-aos="slide-down">
                ...
                <h4 class="extra_subtitle"
                    style="margin: 0 auto;color: #a3a4a3;text-align: center;padding-bottom: 50px;">Ante
                    cualquier consulta o problema no dude en contactarnos vía telefónica o vía email.</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="slide-right">
                <div class="php-email-form">
                    ...
                    <!-- Sección del CAPTCHA comentada -->
                    <!-- 
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                <?= $form->field($model, 'verifyCode')->widget(Captcha::className(), [
                                    'template' => '<div class="row"><div class="col-lg-6">{image}</div><div class="col-lg-6" style ="margin-left: 15px; margin-top: 7px">{input}</div>
                                    </div>',
                                ]) ?>
                            </div>
                        </div>
...
$this->registerJs(" 
		...
		/*$('#reservas-fechae').change(function(){
			var f1 = new Date($(this).val() + ' '+ $('#reservas-horae').val()); 
		...
		$('#reservas-fechas').change(function(){
			var f1 = new Date($(this).val() + ' '+ $('#reservas-horas').val()); 
			var f2 = new Date($('#reservas-fechae').val() + ' '+ $('#reservas-horae').val()); 
...
<script>
	...
	function existeParada() {
		var fechaEntrada = convertDateFormat($('#reservas-fechae').val());
		var horaEntrada = $('#reservas-horae').val();
		var fechaSalida = convertDateFormat($('#reservas-fechas').val());
		var horasalida = $('#reservas-horas').val();

		var f1 = new Date(fechaEntrada + 'T' + horaEntrada);
		var f2 = new Date(fechaSalida + 'T' + horasalida);

		$('.msg-fecha-parada').css('display', 'none');

		$.ajax({
			url: '<?php echo \Yii::$app->getUrlManager()->createUrl('site/parada') ?>',
			type: 'post',
			data: {
			...
			success: function(data) {
				...
				if (Number(data) == 1) {
					$('.msg-fecha-parada').css('display', 'block');
					return null;
				}
 ...
 document.addEventListener("DOMContentLoaded", function() {
    ...
    const submitButton = document.querySelector('[name="contact-button"]');
    ...
    submitButton.addEventListener('click', function(event) {
      ...
      // Si el formulario es válido, redirigir a la página de gracias
      if (form.checkValidity()) {
        // Enviar el formulario (o hacer cualquier otra lógica, si es necesario)
        form.submit();

        // Redirigir a la página de "Gracias"
        window.location.href = '/aparcamiento/site/gracias';  // Cambia '/gracias' con la URL de tu página de gracias
      }
    });
  });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    submitButton.addEventListener('click', function (event) {
        ...
        fetch('/aparcamiento/site/contact', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            console.log(data); // Ver el resultado en la consola

            if (data.success) {
               /**alert(data.message); */
                window.location.href = '/aparcamiento/site/gracias';
            } else {
