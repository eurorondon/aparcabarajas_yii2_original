...
echo "<div id='modalContent'>
 <div class='row'>
    <div class='col-lg-12'>
        ...
        <p align='justify'>APARCABARAJAS  es la solución a su problema de estacionamiento en el Aeropuerto, evitándole así las molestias de buscar aparcamiento e ir desde el parking a la terminal y viceversa, cargado con su equipaje.</p>
        ...
        <p align='justify'>Recogida. veinte minutos antes de llegar a la terminal de salida debe llamar a los conductores al 604194861 para que procedan a la recogida de su vehículo. 
        </p>
...
<div class="reservas-form" style="margin-top: 105px">
			...
			<div class="col-lg-12">
				<div class="panel panel-default panel-d">
					<div class="panel-body panel-datos pnel">
						...
						<div class="col-lg-12 col-xl-12" id="reserva_f"
							style="display:none;border: 1px solid #b0cb21; line-height: 50px; padding: 0 10px; font-weight: 600; ">
							<div class="col-lg-3 d-flex col-xl-3">
								<i>Desde: </i>
							...
							<div class="col-lg-3 d-flex col-xl-3 text-f-r">
								<i>Hasta: </i>
							...
							<div class="col-lg-6 col-xl-6 d-flex justify-content-between button-f-r align-items-center">
								<button type="button" id="change_f" class="btn"
									style="background-color:#B0CB21; margin-left:10px">
									<span class="glyphicon glyphicon-calendar"></span>
									Cambiar fechas
								</button>
								<!--button type="submit" class="btn " style="background-color:#B0CB21"><span class="glyphicon glyphicon-send"></span> Proceder a Reservar</button-->
							</div>
						</div>

						<div class="form-group col-lg-12"
							style="border: 1px solid #b0cb21; padding: 0 10px; font-weight: 600; height: 100px;margin-top: 10px;"
							id="fechas_r">
							<div class="col-lg-12 text-danger" style="display:none" id="alert_fechas">Verifique las
								fechas y horas seleccionadas</div>
							<div class="col-lg-3">
                  ...
                  <span class="tooltipcurved-content">Día y Hora en el que te devolveremos tu coche.</span>
							...
							<div class="col-lg-2"
								...
								<button type="button" id="fecha_update" class="btn"
									style="background-color:#b0cb21">Actualizar fechas</button>
							</div>
						</div>
						...
						<div class="col-lg-12 plan"
							style="border: 1px solid #b0cb21; border-radius: 5px; display: flex;align-items: center;justify-content: space-between;padding: 10px;margin: 10px 0;background: #eee;">
							<div class="col-lg-2" style="">
								<div class="counter_container"
									style="border: 1px solid #b0cb21;    width: 160px;height: 160px;background: #fff;">
									<div class="counter__text">
										<div class="icon"><img class="counter__icon" src="/aparcatest/images/bronce.png"
												alt=""></div>
									</div>
							...
							<div class="col-lg-2" style="">
								<div class="counter_container"
									style="border: 1px solid #b0cb21;    width: 160px;height: 160px;background: #fff;">
									<div class="counter__text">
										<div class="icon"><img class="counter__icon"
												src="/aparcatest/images/chofer1.png" alt=""></div>
							...
							<div class="col-lg-2"
								...
								<div class="counter_container"
									style="border: 1px solid #b0cb21;    width: 160px;height: 160px;background: #fff;">
									<div class="counter__text">
										<div class="icon"><img class="counter__icon" src="/aparcatest/images/car.png"
												alt=""></div>
									</div>
								</div>
							</div>

							<div class="col-lg-2 text-left" style="">
								<h4>Servicios</h4>
								<p>- Parking exterior</p>
								<p class="noctur" style="display:none">- Especial nocturnidad entre 00:31 y 03:45</p>
								<?= Html::button('más inf +', [
							...
							<div class="col-lg-2"
								...
								<svg width="48" height="48" viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg"
									stroke="#000" style="display:none" class="loading">
								...
								<button type="submit" id="bronce" class="btn"
									style="background-color:#B0CB21; padding: 15px 10px">Proceder a Reservar <span
						...
						<div class="col-lg-12 plan"
							...
							<div class="col-lg-2" style="">
								<div class="counter_container "
									style="border: 1px solid #b0cb21;    width: 160px;height: 160px;background: #fff;">
									<div class="counter__text">
										<div class="icon"><img class="counter__icon" src="/aparcatest/images/plata.png"
												alt=""></div>
									</div>
							...
							<div class="col-lg-2"
								...
								<div class="counter_container"
									...
									<div class="counter__text">
										<div class="icon"><img class="counter__icon"
												src="/aparcatest/images/garage-car.png" alt=""></div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-12 plan"
							...
							<div class="col-lg-2" style="">
								<div class="counter_container"
									style="border: 1px solid #b0cb21;    width: 160px;height: 160px;background: #fff;">
									<div class="counter__text">
										<div class="icon"><img class="counter__icon" src="/aparcatest/images/oro.png"
												alt=""></div>
									</div>
							...
							<div class="col-lg-2"
								...
								<div class="counter_container"
									...
									<div class="counter__text">
										<div class="icon"><img class="counter__icon"
												src="/aparcatest/images/interior.png" alt=""></div>
									</div>
								</div>
							</div>
