...
<main class="container_fluid">
  <section class="row">
    ...
    <div class="reserva__container flex-md-column flex-lg-row col-12 d-flex" style="margin-top: 15px">
      ...
      <div class="reserva__ini col-sm-12 col-md-8 col-lg-8">
        ...
        <div class="col-md-12 col-lg-12 mt-4 p-2" style="background-color: #fcfcfc">
          <form>
            ...
            <div class="reserva__factura" id="facturacion" style="display:<?= $model->factura === 1 ? 'block !important' : 'none' ?>">
              <h3 class="pb-3"
                style="border-bottom: 1px solid #e7eaed; margin: 32px 0;">
      ...
      <h3 class="pb-3" style="border-bottom: 1px solid #e7eaed; margin: 32px 0; display:<?= $model->factura == 1 ? 'none !important' : '' ?>">
        Forma de pago
      </h3>
      ...
      <div class="col-12 mt-4 d-flex justify-content-sm-end reserva__total__pagar"
        style="display:<?= $model->factura == 1 ? 'none !important' : '' ?>">
        <div class="col-md-7 col-lg-9 fs-4 text-end mx-2 d-flex justify-content-end align-items-center totales-facturas"
          id="subtotal-factura">
          Total a Pagar
        </div>
  ...
  function recalcular() {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $('#reservas-dias').val(data);
        dias = $('#reservas-dias').val();
        precio_dia = $('#precio_dia').val();
        var total = 0;
