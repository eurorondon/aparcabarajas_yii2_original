          ...
          <div class="panel panel-default panel-d">
            <div class="panel-body panel-datos">
              ...
              <div class="col-lg-3">
                ...
                <div class="info-reserva" style="margin-bottom: 15px"><?= $model->coche->marca; ?></div>
              </div> 
              <div class="col-lg-3">
                <div class="datos-reserva">Modelo</div>      
                <div class="info-reserva" style="margin-bottom: 15px"><?= $model->coche->modelo; ?></div>
              </div>
              <div class="col-lg-3">
                <div class="datos-reserva">Matrícula</div>      
                <div class="info-reserva" style="margin-bottom: 15px"><?= $model->coche->matricula; ?></div>
              </div>       
              <div class="col-lg-3">
                <div class="datos-reserva">Color</div>      
                <div class="info-reserva" style="margin-bottom: 15px"><?= $model->coche->color; ?></div>
              </div> 
            </div>
          </div>
